      ...
      <nav
        ...
        className={cn(
          ...
          isLight
            ...
            : scrolled
              ? "border-white/15 bg-white/[0.08] shadow-[inset_0_1px_0_rgba(255,255,255,0.14),0_8px_32px_rgba(0,0,0,0.28)] backdrop-blur-[20px]"
              : "border-white/12 bg-white/[0.06] shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_8px_32px_rgba(0,0,0,0.22)] backdrop-blur-[16px]",
        )}
      >
        <div
          className={cn(
